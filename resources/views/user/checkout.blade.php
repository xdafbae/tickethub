    ...
    <form method="POST" action="{{ route('user.checkout.confirm', ['event' => $event->id]) }}" style="margin:0;">
        ...
        <div style="border:1px solid var(--admin-border); border-radius:16px; background: rgba(255,255,255,0.06); overflow:hidden;">
            <div style="padding:20px;">
                ...
                <!-- Seat Dipilih + Buttons -->
                <div style="margin-top:16px; border:1px solid var(--admin-border); border-radius:10px; padding:12px; background: rgba(255,255,255,0.04); box-sizing:border-box;">
                    <h3 style="margin: 0 0 8px; font-size: 16px;">Metode Pembayaran</h3>
                    <div style="display:grid; grid-template-columns: 1fr 1fr; gap: 10px;">
                        <label><input type="radio" name="payment_channel" value="permata" checked> Permata VA</label>
                        <label><input type="radio" name="payment_channel" value="bri"> BRI VA</label>
                        <label><input type="radio" name="payment_channel" value="bca"> BCA VA</label>
                        <label><input type="radio" name="payment_channel" value="bni"> BNI VA</label>
                        <label><input type="radio" name="payment_channel" value="gopay"> GoPay</label>
                        <label><input type="radio" name="payment_channel" value="qris"> QRIS</label>
                        <label><input type="radio" name="payment_channel" value="shopeepay"> ShopeePay</label>
                    </div>
                    <div style="color: var(--admin-muted); margin-top:8px;">
                        Catatan: Hanya channel yang aktif di Midtrans MAP yang akan tampil di Snap.
                    </div>
                </div>
